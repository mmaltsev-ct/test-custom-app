...
export default defineMessages({
  title: {
    id: 'Welcome.title',
    defaultMessage: 'Maxim\'s Test Custom Application',
  },
  subtitle: {
    id: 'Welcome.subtitle',
    defaultMessage:
  ...
  contentText: {
    id: 'Welcome.contentText',
    defaultMessage:
      'Hi there! Welcome to my test Custom Application. The goal of this app is to test available functionalities and learn more about Custom Applications.',
  },
});
